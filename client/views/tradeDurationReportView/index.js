...
import { fetchTradeDurationReport } from '../../api/report';
import { ResponsiveBar } from '@nivo/bar';

const { Option } = Select;

const TradeDurationReportView = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			const data = await fetchTradeDurationReport();
			setData(data);
		};
...
export default TradeDurationReportView;
